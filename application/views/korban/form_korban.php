                    ...
                    <div class="col-md-8">
                         <div class="card">
                            <div class="card-header" data-background-color="blue">
                                <h4 class="title">Masukkan Data Korban</h4>
                            </div>
                            <div class="card-content">
                            <form action="<?php echo base_url(). 'index.php/korban_controller/insert_korban'; ?>" method="POST">
                              <div class="row">
                                <div class="col-md-4">
                                  <div class="form-group label-floating is-empty">
                                   ...
                                   <!-- <input type="text" class="form-control" name="id_timsar"/> -->
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                     <label for="jenis_korban"> Status Korban </label>
                                        <select class="form-control" name="id_jenis" id="jenis_korban">
                                          <option value="">- Pilih -</option>
                              ...
                              <div class="row">
                                <div class="col-md-4">
                                  <div class="form-group label-floating is-empty">
                                    <label class="control-label">Lokasi Ditemukan</label>
                                    <input type="text" class="form-control" name="lokasi_korban" />
                                    <span class="material-input"></span>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label class="control-label">Tanggal Ditemukan</label>
                                    <input type="date" id="datepicker" class="form-control" name="tanggal_korban"/>
                                  </div>
                                </div>
                              </div>
