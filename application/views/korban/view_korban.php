            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="blue">
                        <h4 class="title">Data Korban</h4>
                        <a href="<?php echo site_url('korban_controller/input_korban') ?>" class="btn btn-success pull-right">Tambah Data</a>
                    </div>
                        ...
                        <table class="table">
                            <thead class="text-primary">
                                <tr><th style="text-align: center;">No</th>
                                    ...
                                    <th style="text-align: center;">Jenis Korban</th>
                                    <th style="text-align: center;">Jumlah Korban</th>
                                    <th style="text-align: center;">Lokasi Ditemukan</th>
                                    <th style="text-align: center;">Tanggal Ditemukan</th>
                                    <th style="text-align: center;">Tempat Dievakuasi</th>
                                ...
                                <?php
                                  ...
                                  <tr style="text-align: center;">
                                    <td><?php echo $no++ ?></td>
                                    <td><?php echo $r['id_timsar'] ?></td>
                                    <td><?php echo $r['id_jenis'] ?></td>
                                    <td><?php echo $r['jumlah_korban'] ?></td>
                                    <td><?php echo $r['lokasi_korban'] ?></td>
                                    <td><?php echo $r['tanggal_korban'] ?></td>
                                    <td><?php if($r['id_posko']== null){
                                        echo $r['id_rs'];
                                        } else {
                                            echo $r['id_posko'];
                                        } ?></td>
                                    <td>
                                      <a href="<?php echo site_url('korban_controller/edit_korban/'.$r['id_korban']) ?>">Edit</a> <br>
                                      <a href="<?php echo site_url('korban_controller/delete/'.$r['id_korban']) ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a>
                                    </td>
                                  </tr> 
                                <?php } ?> 
                            </thead>
