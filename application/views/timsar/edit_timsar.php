                    ...
                    <div class="col-md-8">
                         <div class="card">
                            <div class="card-header" data-background-color="blue">
                                <h4 class="title">Ubah Data Tim SAR</h4>
                            </div>
                            <div class="card-content">
                              <?php if($dataEdit) {
                                $id = $dataEdit->id_timsar;
                                $nama_timsar = $dataEdit->nama_timsar;
                                $no_hp = $dataEdit->no_hp;
                              } else {
                                $nama_timsar = "";
                              } ?>
                                <form action="<?php echo site_url('timsar_controller/update/'. $id) ?>" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                <label>Nama Tim SAR</label>
                                                 <input type="text" class="form-control" name="nama_timsar" value="<?php echo $nama_timsar ?>" />
