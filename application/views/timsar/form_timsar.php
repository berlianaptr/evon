                    ...
                    <div class="col-md-8">
                         <div class="card">
                            ...
                            <div class="card-content">
                               <form action="<?php echo base_url(). 'index.php/timsar_controller/insert_timsar'; ?>" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label">Nama Tim SAR</label>
                                               <input type="text" class="form-control" name="nama_timsar"/>
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right" value="aksi_create_timsar">Simpan</button>
                                </form>
                            </div>
                        </div>
                    </div>
