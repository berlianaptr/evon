            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header" data-background-color="blue">
                        ...
                        <a href="<?php echo site_url('rs_controller/input_rs') ?>" class="btn btn-success pull-right">Tambah Data</a>
                    </div>
                    <div class="card-content table-responsive">
                        <table class="table">
                             <?php 
 $koneksi     = mysqli_connect("localhost", "root", "", "evon");
$rumah_sakit = mysqli_query($koneksi, "SELECT nama_rs FROM rumah_sakit");
$ketersediaan = mysqli_query($koneksi, "SELECT ketersediaan_rs FROM rumah_sakit");
 ?>
 <html>
    <head>
    ...
    <body>
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                type: 'bar',
                data: {
                    labels: [<?php while ($b = mysqli_fetch_array($rumah_sakit)) { echo '"' . $b['nama_rs'] . '",';}?>],
                    datasets: [{
                            label: 'Kuota',
                            data: [<?php while ($p = mysqli_fetch_array($ketersediaan)) { echo '"' . $p['ketersediaan_rs'] . '",';}?>],
                            backgroundColor: [
                                'rgba(255, 99, 150, 2)',
                                'rgba(54, 162, 200, 2)',
                                'rgba(255, 206, 140, 2)',
                        ...
                        yAxes: [{
                            ...
                            <thead class="text-primary">
                                <tr>
                                    ...
                                    <th style="text-align: center;">Alamat Rumah Sakit</th>
                                    <th style="text-align: center;">Kuota/Ketersediaan</th>
                                ...
                                <?php
                                  ...
                                  <tr style="text-align: center;">
                                    ...
                                    <td><?php echo $r['ketersediaan_rs'] ?></td>
                                    <td>
                                      <a href="<?php echo site_url('rs_controller/edit_rs/'.$r['id_rs']) ?>">Edit</a> <br>
                                      <a href="<?php echo site_url('rs_controller/delete/'.$r['id_rs']) ?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a>
                                    </td>
                                  </tr> 
                                <?php } ?> 
                            </thead>
