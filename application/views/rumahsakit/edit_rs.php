                    ...
                    <div class="col-md-8">
                         <div class="card">
                            <div class="card-header" data-background-color="blue">
                                <h4 class="title">Ubah Data Rumah Sakit</h4>
                            </div>
                            <div class="card-content">
                              <?php if($dataEdit) {
                                $id = $dataEdit->id_rs;
                                $nama_rs = $dataEdit->nama_rs;
                                $alamat_rs = $dataEdit->alamat_rs;
                                $ketersediaan_rs = $dataEdit->ketersediaan_rs;
                              } else {
                                $nama_rs = "";
                                $alamat_rs = "";
                                $ketersediaan_rs = "";
                              } ?>
                                  <form action="<?php echo site_url('rs_controller/update/'. $id) ?>" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                <label>Nama Rumah Sakit</label>
                                                 <input type="text" class="form-control" name="nama_rs" value="<?php echo $nama_rs ?>" disabled />
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" class="form-control" name="alamat_rs" value="<?php echo $alamat_rs ?>" disabled />
                                                <span class="material-input"></span>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" class="form-control" name="ketersediaan_rs" value="<?php echo $ketersediaan_rs ?>"/>
                                                <span class="material-input"></span>
                                            </div>
                                        </div>
                                    </div>
