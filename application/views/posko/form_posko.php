                    ...
                    <div class="col-md-8">
                         <div class="card">
                            <div class="card-header" data-background-color="blue">
                                <h4 class="title">Masukkan Data Posko</h4>
                            </div>
                            <div class="card-content">
                                <form action="<?php echo base_url(). 'index.php/posko_controller/insert_posko'; ?>" method="POST">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label">Nama Posko</label>
                                                <input type="text" class="form-control" name="nama_posko"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                <label class="control-label">Alamat Posko</label>
                                                <input type="text" class="form-control" name="alamat_posko"/>
                                                <span class="material-input"></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group label-floating is-empty">
                                                ...
                                                <input type="text" class="form-control" name="ketersediaan_posko"/>
